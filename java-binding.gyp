        ...
        ['OS=="mac"',
          {
            ...
            'conditions': [
              ['javaver=="Library"',
                {
                  'include_dirs': [
                    '/Applications/XNAT-Desktop-Client.app/Contents/Resources/include',
                    '/Applications/XNAT-Desktop-Client.app/Contents/Resources/include/darwin'
                  ],
                  'libraries': [
                    '-L/Applications/XNAT-Desktop-Client.app/Contents/Resources/jre/lib/jli',
                    '-Wl,-rpath,/Applications/XNAT-Desktop-Client.app/Contents/Resources/jre/lib/jli',
                    '-ljli'
                  ],
                },
              ],
