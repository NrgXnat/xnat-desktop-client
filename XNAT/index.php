...
<div class="container">
	...
	<div class="col-md-12">
		...
		<div class="col"></div>
		<div class="col-8">
			<button class="btn btn-known-user btn-lg btn-block connect" type="button" data-toggle="modal" data-target="#known-user-login">XNAT Central</br>User: Will</button>

			<button class="btn btn-green btn-lg btn-block connect" type="button" data-toggle="modal" data-target="#login"><span class="plus"></span><span class="db"></span> CONNECT TO XNAT SERVER</button>
		</div>
		<div class="col"></div>
		</div>
	</div>
